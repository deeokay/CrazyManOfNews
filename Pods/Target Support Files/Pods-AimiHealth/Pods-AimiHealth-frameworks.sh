...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/CRMediaPickerController/CRMediaPickerController.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MBXPageViewController/MBXPageViewController.framework"
