...
extension UIViewController {
     ...
     */
    func showHud(in view: UIView, hint: String = "加载中...", yOffset:CGFloat = 0 , interaction:Bool = true){
        let HUD = MBProgressHUD(view: view)
        HUD.label.text = hint
        HUD.label.font = UIFont(name: "STHeitiSC-Light", size: 15*UIRate)
        //设为false后点击屏幕其他地方有反应
        HUD.isUserInteractionEnabled = interaction
        //HUD内的内容的颜色
        HUD.contentColor = UIColor(red:0.82, green:0.82, blue:0.82, alpha:1.00)
        //View的颜色
        HUD.bezelView.color = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.7)
