...
class commentMeTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.commentLabel.layer.borderColor = UIColor.lightGray.cgColor
        self.commentLabel.layer.borderWidth = 1.0
        self.commentLabel.backgroundColor = UIColor.init(white: 240, alpha: 1)
